...
root.title("Sanjana Akter Secret Communication Tool")

# Input for message
Label(root, text="My friends Enter your Message:", font=("Helvetica", 12)).pack(pady=5)
text_input = Text(root, height=5, width=50)
text_input.pack(pady=5)

# Input for key
Label(root, text="Enter your Encryption Key:", font=("Helvetica", 12)).pack(pady=5)
key_input = Entry(root, show="*", width=50)
key_input.pack(pady=5)

# Buttons
Button(root, text="Encrypt", command=encrypt_message, bg="lightpink", font=("Helvetica", 12)).pack(pady=10)
Button(root, text="Decrypt", command=decrypt_message, bg="lightblue", font=("Helvetica", 12)).pack(pady=10)

# Result display
Label(root, text="Output (Copyable your output):", font=("Helvetica", 12)).pack(pady=5)
